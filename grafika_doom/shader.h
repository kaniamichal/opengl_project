...
private:
	...
	std::string loadShaderSource(const char* fileName)
	{
		...
		{
			std::cout << "ERROR: SHADER CAN'T OPEN THE FILE: " << fileName << "\n";
		}
	...
	GLuint loadShader(GLenum type, const char* fileName)
	{
		...
		if (!sucess)
		{
			...
			std::cout << "ERROR: SHADER CAN'T COMPILE THE SHADER: " << fileName << "\n";
			std::cout << infoLog << "\n";
		}
	...
	void linkProgram(GLuint vertexShader, GLuint geometryShader, GLuint fragmentShader)
	{
		...
		if (!success)
		{
			...
			std::cout << "ERROR: SHADER CAN'T LINK PROGRAM" << "\n";
			std::cout << infoLog << "\n";
		}
...
public:
	...
	void setVec3fv(glm::fvec3 value, const GLchar* name)
	{
		this->use();
